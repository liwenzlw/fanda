...
//		articleList.add(art10);
		String jsonMsg = CustomServiceTool.makeNewsCustomMessage(openid, articleList);
		CustomServiceTool.sendCustomMessage(accessToken, jsonMsg);
	}
	
	@Test
	public void testSendTextMenu(){
		...
		buffer.append("8 <a href=\"http://m.baidu.com/\">聊天</a>").append("\n\n");
